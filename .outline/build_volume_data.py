# -*- coding: utf-8 -*-
"""
Python Builder to output clean, handcrafted vol1_specs.py to vol6_specs.py.
"""
...
def format_ch(n, vol, title, actors, function, delta_st, conf_c, stakes_c, hook_c, beats, scenes, clusters):
    code = []
    code.append(f"    # {n}")
...
def generate_header(v_num, v_name):
    return f'''# -*- coding: utf-8 -*-
"""Volume {v_num}: {v_name} Handcrafted Specifications"""

def get_vol{v_num}_specs(make_beat, make_scene, make_cluster):
    records = []
